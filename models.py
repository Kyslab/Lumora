...
class Room(db.Model):
    ...
    adults_capacity = db.Column(db.Integer, default=2)
    children_capacity = db.Column(db.Integer, default=0)
    bed_count = db.Column(db.Integer, default=1)
    bed_type_vi = db.Column(db.String(100))
    bed_type_en = db.Column(db.String(100))
